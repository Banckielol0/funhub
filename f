...
local data = http_request({
	Url = ('https://jannesdecooleewaneeftkkr.000webhostapp.com/newwhistlist%20try/index.php?key=' .. key);
	Method = 'GET';
})
...
if data.StatusCode == 200 then
	...
	if response == hash(key) then
		print("whitlisted")
			loadstring(game:HttpGet("https://raw.githubusercontent.com/jannnes124125jahkc/loader-OUO-G-G-/main/cool", true))()
	else 
